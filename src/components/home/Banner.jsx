...
export default function Banner() {
  return (
    ...
    <div
        className="bg-gradient-to-br from-sky-400 via-sky-400 to-violet-400 p-6 sm:p-10 rounded-2xl w-full text-blue-gray-700 flex items-center justify-between max-w-2xl mx-auto mt-20">
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 text-gray-500" viewBox="0 0 15 15">
                <path fill="currentColor" 
