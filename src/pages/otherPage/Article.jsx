...
export default function Article() {
  return (
    <div
    className="flex flex-col sm:flex-row sm:max-w-2xl max-w-xs mx-auto overflow-hidden bg-gray-700 rounded-lg shadow-lg dark:bg-gray-800 p-2">
    ...
    <div className="sm:p-4 p-2 sm:w-1/2 flex flex-col justify-between">
        ...
        <div className="mt-4">
          ...
          >
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#f2f2f2" >
